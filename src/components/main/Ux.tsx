    ...
    <>
      ...
      >
        ...
        <p className="text-justify leading-8 mb-10">
          ...
          Conversion rate is the percentage of visitors who proceed to a
          specific goal on a page.
          <br />
          <br />
          ...
          headline brought you more value. A/B testing software makes it easier
          to conduct such tests. Each of your visitors will see a different
          version of the page - version A or version B, and then the software
          will determine which version performed best.
        </p>
        ...
        <p className="text-justify leading-8 mb-4">
          To create a new AB test, enter links to the two versions of the page
          and to the success page, e.g.:
          <br />
          ...
          traffic equally between the original page and the test version and
          will track the user&apos;s further path. Thanks to cookies, the script
          will know how many people went to the result subpage, which will give
          us information about the number of bounces, conversions and
          effectiveness of a given version of the website.
          <br />
          <br />
          If 1,000 people visit each version of the website, and 200 people go
          from the original version to the cart, we have a 20% conversion. If
          300 people go to the cart from the second version, we have a 30%
          conversion.
        </p>
